# Launch message (WhatsApp)

Draft announcement for the club groups. Two things to swap before sending:

- `<SITE URL>` — the live Vercel URL (or the custom domain), see `DEPLOY.md`.
- `<ORGANISER>` — whoever is taking entries and payments.

Send it once the site is live and verified, not before — the first thing
anyone does is tap the link. Paste the link on its own line so WhatsApp picks
...
> ⚽ **Dukes — Last Man Standing** is back on for the new season.
>
> Simple as it gets: every week you pick one Premier League team to win. They
> win, you're through. They draw or lose, you're out. You can't pick the same
> team twice. Last one standing takes the whole pot.
>
...
> busy — but the good ones go early.
>
> Track who's still in, and who's already out, here:
> <SITE URL>
>
> Full rules on the site: <SITE URL>/rules

---

## Follow-up (optional, the day before the deadline)
